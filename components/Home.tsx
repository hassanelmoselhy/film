...
function PlanCard({ style,name, price, resolution, devices, downloads, spatialAudio  }) {
    ...
    <section id='Home' className='h-fit overflow-hidden w-full m-auto max-w-8xl'>
      ...
      <BgHome/>
        ...
        <div className='flex flex-col items-center justify-center'>
          <h1 className='text-2xl md:text-5xl'>{t('SECTION-ONE-H1')}</h1>
...
{/* for the popular movies */}
      ...
      <div className=' flex flex-col mt-20 gap-10'>
        <div className='flex flex-col'>
          <h1 className='text-2xl md:text-4xl'>{t('SECTION-TWO-H1')}</h1>
...
{/* apps  */}
        <div className="flex justify-center items-center flex-wrap gap-5 text-white m-auto">
          {deviceData.map((device, index) => (
            <div key={index} className='w-80 p-9 rounded-lg h-50 bg-gradient-to-tr from-red-50 to-gray-60 dark:to-black-6 flex flex-col justify-evenly'>
 ...
 {/* questions */}
      <div className="    p-8 max-w-7xl mx-auto mt-10">
         ...
         <div className="space-y-4 flex flex-wrap w-full max-w-6xl">
         {faqs.map((faq, index) => (
         ...
         >
            <div className='mt-2'>
            <span className='bg-black-12 text-white p-2 rounded-md m-2'>{`${index + 1}`.padStart('0')} </span>
